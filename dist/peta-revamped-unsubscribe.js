...
body:not(#en__pagebuilder) .en__field--NOT_TAGGED_134,
...
@media (min-width: 600px) {
  ...
  .less-emails-section .less-emails-paragraph {
    height: 100%;
    margin-bottom: 24px;
  }
  .less-emails-header {
...
const runScript = () => {
  ...
  graphicSVG.querySelector(".off-text");
  graphicSVG.querySelector(".on-text");
